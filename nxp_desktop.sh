...
if [ ! -d "/home/${USER}/git/nxp_ros2_ws/src/px4_ros_com" ];then 
	printf "\nNow cloning git repository using HTTPS.\n"
	cd /home/${USER}/git/nxp_ros2_ws/src
	git clone -b pr-cupcar https://github.com/rudislabs/px4_ros_com.git
else
...
if [ ! -d "/home/${USER}/git/nxp_ros2_ws/src/px4_msgs" ];then 
	printf "\nNow cloning git repository using HTTPS.\n"
	cd /home/${USER}/git/nxp_ros2_ws/src
	git clone -b pr-cupcar https://github.com/rudislabs/px4_msgs.git
else
...
if [ ! -d "/home/${USER}/git/nxp_gazebo" ];then 
	printf "\nNow cloning git repository using HTTPS.\n"
	cd /home/${USER}/git
	git clone -b ros2 https://github.com/rudislabs/nxp_gazebo.git
else
...
if [ ! -d "/home/${USER}/git/PX4-Autopilot" ];then 
	printf "\nNow cloning git repository using HTTPS.\n"
	cd /home/${USER}/git
	git clone -b pr-cupcar https://github.com/rudislabs/PX4-Autopilot.git
else
